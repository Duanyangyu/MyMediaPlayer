...
/**
 * Created by duanyy on 2018/3/28.
 * 工具类：用于创建OpenGL环境
 */
...
public class EGLHelper {
    ...
    public boolean createGLES(int eglWidth, int eglHeight){
        int[] attributes = new int[] {
                ...
                mEGLDisplay= EGL14.eglGetDisplay(EGL14.EGL_DEFAULT_DISPLAY);         //获取版本号，[0]为版本号，[1]为子版本号
                ...
                log(EGL14.eglQueryString(mEGLDisplay, EGL14.EGL_EXTENSIONS));         //获取EGL可用配置
